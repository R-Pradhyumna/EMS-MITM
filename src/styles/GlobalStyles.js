...
:root {
  /* ☀️ Light Mode (Warm Linen) */
  &, &.light-mode {
    --color-grey-0: #ffffff;
    --color-grey-50: #f4f2ed;
    --color-grey-100: #e7e5e1;
    --color-grey-200: #dcd9d3;
    --color-grey-300: #d1ccc5;
...
/* --- 👇 FADING DOOR TRANSITION (RELIABLE & LAG-FREE) 👇 --- */
...
/* Create two pseudo-elements to act as the fading layers */
body::before,
body::after {
  content: '';
  position: fixed;
