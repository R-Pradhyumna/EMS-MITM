...
// Bhai I have exported these components for you to use in TableSkeleton.jsx
...
export const StyledBody = styled.section`
  margin: 0.4rem 0;
  background-color: var(--color-grey-0); /* Added background */
`;
...
function Body({ data, render }) {
  ...
  return <StyledBody>{data.map((row, idx) => render(row, idx))}</StyledBody>;
}
